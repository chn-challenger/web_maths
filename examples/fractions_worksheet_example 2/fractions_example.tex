...
\begin{document}
	...
	\vspace{10 mm}
	\begin{align*}
		1.\hspace{15pt}48+6\left(44+\frac{x}{3}\right)&=318&2.\hspace{15pt}23+\frac{85}{2x+9}&=28\\[1em]
		4&=2\left(\frac{x}{9}+14\right)-26&4.\hspace{15pt}5\left(36+\frac{x}{7}\right)-9&=176\\[1em]
		15.\hspace{15pt}3\left(\frac{72}{x-2}+21\right)&=90&16.\hspace{15pt}2\left(4+\frac{27}{x}\right)-4&=10
	\end{align*}
\end{document}
